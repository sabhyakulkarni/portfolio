...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title"> Sabhya
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">
                <br />Hey! My name is Sabhya Kulkarni and I am a student of PES University, Bengaluru. I am a developer and my field of interest is in Machine Learning and Data Science. Welcome to my portfolio!😊
            </p>

            <a href="https://www.linkedin.com/in/sabhya-kulkarni-b1b6472bb/" rel="noreferrer" target = "_blank" className="button button--flex">
                Say Hello
                <svg
